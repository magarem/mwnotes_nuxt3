  ...
  <div class="wrapper dark-mode">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">MW Notes</span>
      </a>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <!-- Add icons to the links using the .nav-icon class
                 ...
                 <li class="nav-item"  v-for='(item, index) in menuLinks' 
                            :key='item.id' >
...
const menuLinks = ref([
  {id: 0, name: 'Home', link: '/'},
  {id: 1, name: 'Listagem', link: '/regs_list'},
  // {id: 1, name: 'Paginas', link: '/pages'},
  {id: 1, name: 'Editar', link: '/form'},
  // {id: 1, name: 'Testes', link: '/testes'}
])
</script>